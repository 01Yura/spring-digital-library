...
public class BookMessageService {
    ...
    private static final String GEMINI_PROMPT_TEMPLATE = """
            ...
            При ответе не упоминай кто отвечает, не говори имена участников катастрофы и обстоятельства ответа (про выживание и то что нечего есть так далее), 
            ...
            Расскажи как ты получил эту книгу (купил, нашел, выиграл, подарили, украл, взял напрокат, скачал, приснилась во сне, выбери в общем любой вариант или придумай свой),
            расскажи пару фактов об авторе и самой книге, о своих впечатлениях и мыслях. В общем поделись мнением.
