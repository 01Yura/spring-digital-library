...
public class BookMessageController {
    ...
    @Operation(
            ...
            description = "Отправляет сообщение (вопрос) рандомному читателю, который прочитал книгу. " +
                    "Читатель отвечает. Однако сообщение приходит не сразу, так как ему надо время на написание ответа. Подождите 20-30 сек, будьте терпиливы, человек старается." +
